...
//       Long int:
//          random_number = next_random_long_int(&rng_rng_statei) ;
...
//    randnum: next random number
/////////////////////////////////////////////////////////////////////////////
long next_random_long_int(rng_int_t *rng_int);
