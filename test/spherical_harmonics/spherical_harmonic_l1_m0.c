...
#include <spherical_harmonics_l1_m0.h>

double reference_spherical_harmonics_l1_m0(double x, double y, double z) {
   ...
   for (double r=rmin; r<=rmax; r+=deltar) {
      for (double phi=phimin; phi<=phimax; phi+=deltaphi) {
         for (double theta=thetamin; theta<=thetamax; theta+=deltatheta) {
            ...
            double reference = reference_spherical_harmonics_l1_m0(x, y, z);
            double testval = spherical_harmonics_l1_m0(x, y, z);
